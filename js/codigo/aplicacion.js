define(["jquery","./modelo/aparcamientos","./vista/mapaAparcamientos"],function($,APARCAMIENTOS,Mapa){
...
*/
	var aparcamientos = new APARCAMIENTOS();
	var mapaAparcamientos = new Mapa({collection : aparcamientos});
